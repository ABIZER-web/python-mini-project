...
class MillionaireTrackApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Millionaire Track")
    ...
    def add_home_content(self, frame):
        title = tk.Label(frame, text="Welcome to Millionaire Track", font=("Arial", 16, "bold"), fg="white", bg="#2c3e50")
        title.pack(pady=10)
        ...
        description = tk.Label(frame, text=(
            ...
            "At Millionaire Track Private Limited, we offer the finest learning experience and unparalleled growth opportunities."
        ...
        # Call to Action
        call_to_action = tk.Label(frame, text="Join Millionaire Track today and transform your career!",
    ...
    def add_support_content(self, frame):
        ...
        # Footer
        footer = tk.Label(frame, text="All Rights Reserved © 2025 | Millionaire Track Pvt. Ltd.",
